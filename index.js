...
function add_expense(){
    ...
    var category = document.getElementsByClassName("form-input").selectedIndex;
...
function add_category(){
    ...
    if(new_category_value){
        ...
        new_category_option.innerHTML = `<options>${new_category_value}</option>`;
        count++;
        ...
        document.getElementsByClassName("add-category")[0].getElementsByClassName("add-category")[0].style.display = "none";
    }
}
